...
class Exercise4(app_manager.RyuApp):
    ...
    def packet_in(self, event):
        ...
        mtch = parser.OFPMatch(in_port=inpt, ipv4_src='0.0.0.0', ipv4_dst=arpp.src_ip, ip_proto=0, eth_type=0x0800)
        self.send_flow(path, 15, mtch, acts)
